const CONFIG = {
  ...
  MAGZINE_HOME_BUTTON_URL: 'mailto://tidewavereport@gmail.com',
  MAGZINE_HOME_BUTTON_TEXT: '投稿入口',

  MAGZINE_HOME_HIDDEN_CATEGORY: '分享杂文', //不希望在首页展示的文章分类，用英文逗号隔开

  MAGZINE_HOME_TITLE: '想要毫无拘束地自由创作并向世界展示你的文字吗？',
  MAGZINE_HOME_DESCRIPTION:
    ' Tide Press，让世界看到你的想法',
  MAGZINE_HOME_TIPS: '',
  ...
  //categoroy
  MAGZINE_HOME_CATEGORY_GROUP_ENABLE: process.env.NEXT_PUBLIC_MAGZINE_HOME_CATEGORY_GROUP_ENABLE || true, // 首页分类文章板块
  MAGZINE_HOME_CATEGORY_GROUP_MAX_COUNT: process.env.NEXT_PUBLIC_MAGZINE_HOME_CATEGORY_GROUP_MAX_COUNT || 10, // 首页最多显示多少个分类模块
  MAGZINE_HOME_CATEGORY_GROUP_POST_MAX_COUNT: process.env.NEXT_PUBLIC_MAGZINE_HOME_CATEGORY_GROUP_POST_MAX_COUNT || 6, // 每个分类模块最多显示几篇文章
