...
const Footer = ({ title }) => {
  ...
  // Close when clicking outside (works for both touch and mouse)
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-3xl w-full mx-auto ">
        ...
        <div className="w-full flex lg:flex-row flex-col justify-between py-16 items-start">
          {/* --- 左侧区块：包含图标、版权 --- */}
          <div className="flex-1 flex items-center gap-x-4 py-6">
          ...
          {/* --- 右侧链接区块 --- */}
          <div className="flex-1 lg:flex-none lg:w-auto py-6">
