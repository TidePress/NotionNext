...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tidepress.ink', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Tide Press', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/TidePress/icons/refs/heads/main/favicon.ico', // blog favicon 配置, 默认使用 /favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
