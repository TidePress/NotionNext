...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '',
  THEME: process.env.NEXT_PUBLIC_THEME || '', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tidepress.top', // 网站地址
